...
const SUBJECTS = [
  ...
  { 
    ...
    comisiones: [
      ...
      { id: 'S12', duration: 'A', dias: [{ nombre: 'Lunes', inicio: '08:00', fin: '12:30' }] },
      { id: 'S13', duration: 'A', dias: [{ nombre: 'Jueves', inicio: '17:00', fin: '21:00' }] },
      { id: 'S14', duration: 'A', dias: [{ nombre: 'Martes', inicio: '19:15', fin: '23:15' }] },
      { id: 'S15', duration: 'A', dias: [{ nombre: 'Jueves', inicio: '13:15', fin: '17:15' }] },
      { id: 'S16', duration: 'A', dias: [{ nombre: 'Martes', inicio: '13:00', fin: '15:15' }, { nombre: 'Miércoles', inicio: '09:45', fin: '11:15' }] }
    ]
  },
  { 
    id:2, num:'02', name:'Algebra y Geometría Analítica', hours:'5 hs/sem', level:1, correlCursada:[], correlAprobada:[],
    comisiones: [
      { id: 'S10', duration: 'A', dias: [{ nombre: 'Viernes', inicio: '08:00', fin: '12:00' }] },
      { id: 'S11', duration: 'A', dias: [{ nombre: 'Martes', inicio: '08:00', fin: '12:00' }] },
      { id: 'S12', duration: 'A', dias: [{ nombre: 'Miércoles', inicio: '10:30', fin: '14:30' }] },
      { id: 'S13', duration: 'A', dias: [{ nombre: 'Viernes', inicio: '18:00', fin: '22:00' }] },
      { id: 'S14', duration: 'A', dias: [{ nombre: 'Jueves', inicio: '18:00', fin: '22:00' }] },
      { id: 'S15', duration: 'A', dias: [{ nombre: 'Miércoles', inicio: '13:15', fin: '17:15' }] },
      { id: 'S16', duration: 'A', dias: [{ nombre: 'Viernes', inicio: '11:00', fin: '15:00' }] }
    ]
  },
  { 
    id:3, num:'03', name:'Fisica I', hours:'5 hs/sem', level:1, correlCursada:[], correlAprobada:[],
    comisiones: [
      { id: 'S10', duration: 'A', dias: [{ nombre: 'Miércoles', inicio: '09:00', fin: '13:00' }] },
      { id: 'S11', duration: 'A', dias: [{ nombre: 'Jueves', inicio: '11:30', fin: '15:30' }] },
      { id: 'S12', duration: 'A', dias: [{ nombre: 'Viernes', inicio: '10:00', fin: '14:00' }] },
      { id: 'S13', duration: 'A', dias: [{ nombre: 'Martes', inicio: '19:30', fin: '23:30' }] },
      { id: 'S14', duration: 'A', dias: [{ nombre: 'Viernes', inicio: '18:30', fin: '22:30' }] },
      { id: 'S15', duration: 'A', dias: [{ nombre: 'Lunes', inicio: '15:00', fin: '19:00' }] },
      { id: 'S16', duration: 'A', dias: [{ nombre: 'Jueves', inicio: '08:00', fin: '12:00' }] }
    ]
  },
  ...
  { 
    id:13, num:'13', name:'Sintaxis y Semántica del Lenguaje', hours:'4 hs/sem', level:2, correlCursada:[5,6], correlAprobada:[],
    comisiones: [
  ...
  { 
    id:14, num:'14', name:'Paradigmas de Programación', hours:'4 hs/sem', level:2, correlCursada:[5,6], correlAprobada:[],
    comisiones: [
  ...
  { 
    id:18, num:'18', name:'Economía', hours:'3 hs/sem', level:3, correlCursada:[], correlAprobada:[1,2],
    comisiones: [
  ...
  { 
    id:19, num:'19', name:'Bases de Datos', hours:'4 hs/sem', level:3, correlCursada:[13,16], correlAprobada:[5,6],
    comisiones: [
  ...
  { 
    id:21, num:'21', name:'Comunicación de Datos', hours:'4 hs/sem', level:3, correlCursada:[], correlAprobada:[3,7],
    comisiones: [
  ...
  { 
    id:26, num:'26', name:'Redes de Datos', hours:'4 hs/sem', level:4, correlCursada:[15,21], correlAprobada:[],
    comisiones: [
  ...
  { 
    id:28, num:'28', name:'Simulación', hours:'3 hs/sem', level:4, correlCursada:[17], correlAprobada:[9],
    comisiones: [
  ...
  { 
    id:29, num:'29', name:'Tecnologías para la Automatización', hours:'3 hs/sem', level:4, correlCursada:[10,22], correlAprobada:[9],
    comisiones: [
  ...
  // ── QUINTO NIVEL ──
  { 
    id:31, num:'31', name:'Inteligencia Artificial', hours:'3 hs/sem', level:5, correlCursada:[28], correlAprobada:[17,22],
    comisiones: [
      { id: 'S51', duration: '1', dias: [{ nombre: 'Sábado', inicio: '08:00', fin: '12:30' }] }
    ]
  },
  { 
    id:32, num:'32', name:'Ciencia de Datos', hours:'3 hs/sem', level:5, correlCursada:[28], correlAprobada:[17,19],
    comisiones: [
  ...
  { 
    id:35, num:'35', name:'Seguridad en los Sistemas de Información', hours:'3 hs/sem', level:5, correlCursada:[26,30], correlAprobada:[20,21],
    comisiones: [
...
const ELECTIVAS = {
  3: [
    { 
      id:'E2', num:'E1', name:'Sistemas de Tiempo Real', hours:'6 hs/sem (3 hs anuales)', annualHours: 3, correlCursada:[15], correlAprobada:[7],
      comisiones: [
    ...
    { 
      id:'E3', num:'E2', name:'Tecnología y Gestión Web', hours:'4 hs/sem (2 hs anuales)', annualHours: 2, correlCursada:[13,15], correlAprobada:[6],
      comisiones: [
    ...
    { 
      id:'E4', num:'E3', name:'Sistemas de Transmisión y Redes Inalámbricas', hours:'4 hs/sem (2 hs anuales)', annualHours: 2, correlCursada:[9], correlAprobada:[7],
      comisiones: [
    ...
    { 
      id:'E5', num:'E4', name:'Responsabilidad Social e Institucional', hours:'4 hs/sem (2 hs anuales)', annualHours: 2, correlCursada:[8,16], correlAprobada:[],
      comisiones: [
    ...
    { id:'E22', num:'Fuera del plan', name:'Programación Concurrente', hours:'4 hs/sem (2 hs anuales)', annualHours: 2, correlCursada:[14,15], correlAprobada:[], isOutdated: true },
  ...
  4: [
    { 
      id:'E7', num:'E6', name:'Administración de Base de Datos', hours:'4 hs/sem (2 hs anuales)', annualHours: 2, correlCursada:[19], correlAprobada:[15],
      comisiones: [{ id: 'S41', duration: '2', dias: [{ nombre: 'Martes', inicio: '20:15', fin: '23:15' }] }]
    },
    { 
      id:'E8', num:'E7', name:'Desarrollo de Software Cloud', hours:'4 hs/sem (2 hs anuales)', annualHours: 2, correlCursada:[15,20,23], correlAprobada:[13,14],
      comisiones: [{ id: 'S41', duration: '2', dias: [{ nombre: 'Lunes', inicio: '17:15', fin: '20:15' }] }]
    },
    { 
      id:'E9', num:'E8', name:'Diseño Inclusivo para Usuarios con Discapacidad', hours:'4 hs/sem (2 hs anuales)', annualHours: 2, correlCursada:[23], correlAprobada:[16],
      comisiones: [{ id: 'S41', duration: '1', dias: [{ nombre: 'Sábado', inicio: '11:00', fin: '14:00' }] }]
    },
    { 
      id:'E11', num:'E9', name:'Metodologías Agiles', hours:'6 hs/sem (3 hs anuales)', annualHours: 3, correlCursada:[19,20,23], correlAprobada:[16],
    ...
    { 
      id:'E14', num:'E11', name:'Aplicaciones Moviles', hours:'4 hs/sem (2 hs anuales)', annualHours: 2, correlCursada:[14,23], correlAprobada:[6],
      comisiones: [{ id: 'S41', duration: '1', dias: [{ nombre: 'Martes', inicio: '20:15', fin: '23:15' }] }]
    },
    { id:'E23', num:'Fuera del plan', name:'Metodología de la Investigación', hours:'4 hs/sem (2 hs anuales)', annualHours: 2, correlCursada:[23], correlAprobada:[], isOutdated: true },
    { id:'E24', num:'Fuera del plan', name:'Tecnología de Interfaces Interactivas', hours:'4 hs/sem (2 hs anuales)', annualHours: 2, correlCursada:[16], correlAprobada:[23], isOutdated: true },
  ],
  5: [
    { 
    ...
    { 
      id:'E17', num:'E13', name:'Protocolos y Seguridad en Redes Inalámbricas', hours:'4 hs/sem (2 hs anuales)', annualHours: 2, correlCursada:[21,26], correlAprobada:[9,10],
      comisiones: [{ id: 'S51', duration: '1', dias: [{ nombre: 'Viernes', inicio: '20:15', fin: '23:15' }] }]
    },
    { 
      id:'E18', num:'E14', name:'Sistemas en la Industria 4.0', hours:'6 hs/sem (3 hs anuales)', annualHours: 3, correlCursada:[19,21,25,26], correlAprobada:[7],
      comisiones: [{ id: 'S51', duration: '2', dias: [{ nombre: 'Viernes', inicio: '18:00', fin: '22:30' }] }]
    },
    { 
      id:'E19', num:'E15', name:'Tecnologias de Información para la Gestión Empresarial', hours:'4 hs/sem (2 hs anuales)', annualHours: 2, correlCursada:[25], correlAprobada:[23],
