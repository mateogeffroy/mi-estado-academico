// src/lib/data/unlp/sistemas-2021.ts

export const careerInfo = {
  id: 'unlp-sistemas-2021',
  universidad: 'UNLP',
  nombre: 'Licenciatura en Sistemas',
  plan: 'Plan 2021',
  tituloIntermedio: 'Analista en TIC',
  tituloFinal: 'Licenciado/a en Sistemas',
  creditosTotales: 0,
};
...
export const SUBJECTS = [
  ...
  { id: 'S0303', num: '25', name: 'Bases de Datos 1', hours: '2S', duration: '2', level: 3, correlCursada: [], correlAprobada: ['SI210', 'SI208'] },

  // ── CUARTO AÑO ──
  // Séptimo Semestre (1S)
  { id: 'S0407', num: '26', name: 'Fundamentos de la Teoría de la Computación', hours: '1S', duration: '1', level: 4, correlCursada: [], correlAprobada: ['SI308', 'SI306'] },
  { id: 'SI403', num: '27', name: 'Sistemas Operativos', hours: '1S', duration: '1', level: 4, correlCursada: [], correlAprobada: ['SI304'] },
  { id: 'SI405', num: '28', name: 'Bases de Datos 2', hours: '1S', duration: '1', level: 4, correlCursada: [], correlAprobada: ['S0303'] },
  { id: 'S0406', num: '29', name: 'Ingeniería de Software 3', hours: '1S', duration: '1', level: 4, correlCursada: [], correlAprobada: ['SI308', 'SI202'] },
  // Octavo Semestre (2S)
  { id: 'S0410', num: '30', name: 'Sistemas y Organizaciones', hours: '2S', duration: '2', level: 4, correlCursada: [], correlAprobada: ['SI210', 'SI202', 'SI208'] },
  { id: 'SI409', num: '31', name: 'Matemática 4', hours: '2S', duration: '2', level: 4, correlCursada: [], correlAprobada: ['SI308'] },
  { id: 'S0408', num: '32', name: 'Desarrollo de Software en Sistemas Distribuidos', hours: '2S', duration: '2', level: 4, correlCursada: [], correlAprobada: ['SI301', 'S0303', 'SI304'] },
  { id: 'REQ4', num: 'E1', name: 'Optativa 1 LS', hours: '1 Asign.', duration: '2', level: 4, correlCursada: [], correlAprobada: [], isElectivePlaceholder: true, targetHours: 1 },

  // ── QUINTO AÑO ──
  // Noveno Semestre (1S)
  { id: 'SI504', num: '33', name: 'Aspectos Sociales y Profesionales de Informática', hours: '1S', duration: '1', level: 5, correlCursada: [], correlAprobada: ['SI305'] },
  { id: 'SI505', num: '34', name: 'Aspectos Éticos, Sociales y Profesionales Avanzados de Informática', hours: '1S', duration: '1', level: 5, correlCursada: [], correlAprobada: ['SI305'] },
  { id: 'REQ5', num: 'E2', name: 'Optativa 2 LS', hours: '1 Asign.', duration: '1', level: 5, correlCursada: [], correlAprobada: [], isElectivePlaceholder: true, targetHours: 1 },
  // Para la tesina se exigen todos los finales de 1ro y 2do año, más 2 exámenes adicionales
  { id: 'OI503', num: '35', name: 'Tesina de Licenciatura en Sistemas', hours: '1S', duration: '1', level: 5, correlCursada: [], correlAprobada: ['SI106', 'SI104', 'SI101', 'SI107', 'SI105', 'SI102', 'SI209', 'SI203', 'SI207', 'SI210', 'SI202', 'SI206', 'SI204', 'SI208'] },
];

export const ELECTIVAS = {
  4: [
    // Optativas de otros planes
    ...
    { id: 'OI502', num: 'OP', name: 'Diseño de Experiencia de Usuario', hours: '1S', duration: '1', level: 4, correlCursada: [], correlAprobada: ['S0406'] },
    ...
    { id: 'OI402', num: 'OP', name: 'Laboratorio de Software', hours: '2S', duration: '2', level: 4, correlCursada: [], correlAprobada: ['SI305'] },
    { id: 'OI406', num: 'OP', name: 'Lógica e Inteligencia Artificial', hours: '2S', duration: '2', level: 4, correlCursada: [], correlAprobada: ['SI102', 'SI306'] },
    ...
    { id: 'OI405', num: 'OP', name: 'Programación Distribuida y Tiempo Real', hours: '2S', duration: '2', level: 4, correlCursada: [], correlAprobada: ['SI306', 'SI304'] },
    ...
    { id: 'OI404', num: 'OP', name: 'Sistemas Paralelos', hours: '1S', duration: '1', level: 4, correlCursada: [], correlAprobada: ['SI301'] },
    { id: 'OP-TPG', num: 'OP', name: 'Taller de Programación sobre GPU', hours: '2S', duration: '2', level: 4, correlCursada: [], correlAprobada: ['SI301'] },
    { id: 'OI401', num: 'OP', name: 'Teoría de la Computación y Verificación de Programas', hours: '1S', duration: '1', level: 4, correlCursada: [], correlAprobada: ['S0407'] },
