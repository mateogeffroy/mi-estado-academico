  ...
  return (
    <div className="custom-calendar-container">
      <style>{`
        ...
        .calendar-inner {
          min-width: 800px; /* Evita que las tarjetas colapsen en mobile, permite scroll X */
          display: flex;
        ...
        .calendar-body {
          ...
          grid-template-columns: 60px repeat(6, 1fr);
          position: relative;
          height: 800px; /* Altura total de la grilla de tiempo */
        }
        ...
        .event-card {
          position: absolute;
          left: 4px; right: 4px; /* Margen horizontal interno */
          border-radius: 8px;
          padding: 8px 10px;
          display: flex;
          flex-direction: column;
        ...
        /* Scrollbar custom para que combine con el diseño oscuro/claro */
            ...
            <div key={dia} className="day-column">
              {horarios[dia]?.map(clase => {
                ...
                return (
                  ...
                  >
                    <div style={{ fontWeight: 'bold', fontSize: '0.85rem', color: 'var(--text-strong)', lineHeight: 1.2, marginBottom: '4px' }}>
                      {clase.materiaLimpia}
                    </div>
                    <div style={{ fontSize: '0.7rem', color: clase.colorBorde, fontWeight: 700, marginBottom: 'auto' }}>
                      {clase.cuatrimestre}
                    </div>
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', marginTop: '6px' }}>
                      <span style={{ fontFamily: 'Space Mono, monospace', fontSize: '0.7rem', color: 'var(--text-strong)', opacity: 0.8 }}>
                        Com. {clase.comision}
                      </span>
                      <span style={{ fontFamily: 'Space Mono, monospace', fontSize: '0.7rem', color: 'var(--text-strong)', opacity: 0.6, fontWeight: 'bold' }}>
